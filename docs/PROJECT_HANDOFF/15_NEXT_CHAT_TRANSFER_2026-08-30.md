...
GitHub metadata independently verifies the documentation chain continuously through **CMP #4257**.
...
Полная непрерывная chain #4160–#4257 находится в `16_CMP_4160_4162_GREEN_2026-08-30.md`.
...
#4255 verifies the transfer through #4251, #4256 verifies the snapshot through #4254, and #4257 verifies the entrypoint through #4254.
