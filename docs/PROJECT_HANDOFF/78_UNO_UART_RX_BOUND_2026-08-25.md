...
## Review decision: JOB reply TX stack buffer
...
After fresh CI for the RX-bound batch, continue only narrow evidence-backed Uno memory/reliability review. Avoid broad rewrites and avoid adding flash-heavy helpers solely to remove small temporary stack buffers.
