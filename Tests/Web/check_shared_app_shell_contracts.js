...
// app-shell.js is the runtime owner of primary navigation. It normalizes legacy
// side/bottom menus when present and generates the correct variant menu when a
// standalone page has no local navigation markup.
...
// Every desktop feature route now has a mobile counterpart. more.html remains a
// deliberate mobile-only navigation hub and maps to /desktop/.
...
// Audit every current HTML page, not a hand-picked subset. Primary navigation
// may be static or generated by the authoritative shell, but page content and
// all explicit desktop/mobile HTML targets must remain valid.
