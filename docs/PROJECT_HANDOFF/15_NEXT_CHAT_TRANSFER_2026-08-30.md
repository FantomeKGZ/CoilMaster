...
GitHub metadata independently verifies the documentation chain continuously through **CMP #4290**.
...
Полная непрерывная chain #4160–#4290 находится в `16_CMP_4160_4162_GREEN_2026-08-30.md`.

Latest exact independently verified GREEN SHA before this documentation refresh:

```text
f5798845043f93ff779ce4af1235e8f58329718f
CMP Protocol Tests #4290  run 33304591751 / SUCCESS
```

#4288 verifies the transfer through #4284, #4289 verifies the snapshot through #4287, and #4290 verifies the entrypoint through #4287.
