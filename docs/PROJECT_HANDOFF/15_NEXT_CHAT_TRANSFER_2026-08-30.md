...
GitHub metadata independently verifies the documentation chain continuously through **CMP #4489**.
...
Полная непрерывная chain #4160–#4489 находится в `16_CMP_4160_4162_GREEN_2026-08-30.md`.
...
#4486 verifies the transfer through #4482 (`3454d27e339d1437dae7ba449cd2fbb2cf7ce475`). #4487 verifies the snapshot through #4485 (`30500d9207c3009b12767e22e8f078189cc36c81`), #4488 verifies the entrypoint through #4485 (`a3e81c256bab539f355b4a29d74caf2b4a40c74f`), and #4489 verifies the transfer through #4485 (`a5efdbe5caec9146ba606d9038022eeb87e59e5b`). Thus the entire previous HANDOFF triplet through #4485 is independently verified GREEN. New documentation commits through #4489 are newer than this exact verified GREEN and must not be called GREEN without their own exact CI evidence.
