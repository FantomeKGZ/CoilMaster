...
#4554 verifies transfer through #4551. #4555/#4556/#4557 independently verify the snapshot/entrypoint/transfer HANDOFF through #4553. Thus all HANDOFF documentation through `3350fc4aeef7351487c1437105254b5e3b4469d6` is independently CMP-GREEN.
...
New docs commits after #4557 require their own exact run before being called GREEN. Documentation-only CI recursion must not become the main activity.
