...
GitHub metadata independently verifies the documentation chain continuously through **CMP #4233**.
...
Полная непрерывная chain #4160–#4233 находится в `16_CMP_4160_4162_GREEN_2026-08-30.md`.

Latest exact independently verified GREEN SHA before this documentation refresh:

```text
78ef48ea1e53d01abc105596cce217d67f8987de
CMP Protocol Tests #4233  run 33302914464 / SUCCESS
```

#4232 verifies the snapshot through #4231, and #4233 verifies the entrypoint through #4231.
