...
GitHub metadata independently verifies the documentation chain continuously through **CMP #4293**.
...
Полная непрерывная chain #4160–#4293 находится в `16_CMP_4160_4162_GREEN_2026-08-30.md`.
...
#4291 verifies the transfer through #4287, #4292 verifies the snapshot through #4290, and #4293 verifies the entrypoint through #4290.
