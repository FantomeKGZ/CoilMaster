...
## GREEN foundation through checkpoint 150
...
```text
14ea791ca5741e9aec75d00b80e2c523a34a7d82  production source through 149; checkpoint 150 is NO-CHANGE
...
3. MaterialRequestStore append has already been checked at this boundary and performs only one request-log scan; do not change it for this optimization.
4. Keep separate-ledger validation when different files prove different integrity domains.
5. Prefer explicit result channels over bool-only convenience existence APIs.
