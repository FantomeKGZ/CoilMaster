...
`#4066–#4067` and `#4071–#4076` are documentation-only handoff confirmations. `#4068/#1778/#207` and `#4069/#1779/#208` are exact code/build evidence for the desktop/mobile static selector cleanup. `#4070` is exact for the checkpoint-167 source-text regression contract. These runs do not replace the exact Hall firmware acceptance evidence for checkpoint 166 (`CMP #4028` + Arduino RU LCD `#206`).
