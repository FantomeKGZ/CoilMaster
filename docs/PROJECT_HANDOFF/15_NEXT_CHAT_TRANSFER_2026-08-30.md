...
GitHub metadata independently verifies the documentation chain continuously through **CMP #4314**.
...
Полная непрерывная chain #4160–#4314 находится в `16_CMP_4160_4162_GREEN_2026-08-30.md`.

Latest exact independently verified GREEN SHA before this documentation refresh:

```text
83d11c4945623a7a6a7ec5fe55a1c2a62f6806b4
CMP Protocol Tests #4314  run 33305260008 / SUCCESS
```

#4312 verifies the transfer through #4308, #4313 verifies the snapshot through #4311, and #4314 verifies the entrypoint through #4311.
