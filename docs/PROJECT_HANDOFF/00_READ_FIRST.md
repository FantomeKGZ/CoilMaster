...
#4549/#4550/#4551 independently verify the snapshot/entrypoint/transfer HANDOFF through #4548. Thus all HANDOFF documentation through `8709a6f118d0c100c2fa9d6620128c60e1d8b7a5` is independently CMP-GREEN.
...
New docs commits after #4551 require their own exact run before being called GREEN. Documentation-only CI recursion must not become the main activity.
