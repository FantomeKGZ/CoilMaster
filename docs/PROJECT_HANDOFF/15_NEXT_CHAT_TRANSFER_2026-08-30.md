...
GitHub metadata independently verifies the documentation chain continuously through **CMP #4236**.
...
Полная непрерывная chain #4160–#4236 находится в `16_CMP_4160_4162_GREEN_2026-08-30.md`.

Latest exact independently verified GREEN SHA before this documentation refresh:

```text
d0323c50c59837074bcf20f885ad4960a9ee5197
CMP Protocol Tests #4236  run 33303028918 / SUCCESS
```

#4234 verifies the transfer through #4231, #4235 verifies the snapshot through #4233, and #4236 verifies the entrypoint through #4233.
